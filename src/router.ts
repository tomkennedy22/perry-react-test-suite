...
export function mountRouter(router: AppRouter, opts: RouterOpts) {
  // Register IPC handlers for queries and mutations
  ...
  // Call this after the window's renderer has loaded to start push subscriptions
...
function startDevServer(router: AppRouter) {
  const server = http.createServer((req, res) => {
    ...
    // Routes: /trpc/<ns>.<name>  or  /trpc/<ns>.<name>/subscribe
